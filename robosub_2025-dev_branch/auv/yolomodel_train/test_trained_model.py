...
model = YOLO('C:/Users/HOME/Downloads/best.pt')  # Change to your actual model path

# Run detection on your video
results = model.predict(
    source='C:/Users/HOME/Documents/GitHub/CV_data/poles_test_1.mp4',    # Path to your video
